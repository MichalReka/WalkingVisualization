...
public class DatabaseHandler : MonoBehaviour
{
    ...
    public static void AddDataToTable()
    {
        ...
        if (!PlayerPrefs.HasKey("visualizationDataTableCreated"))
        {
            CreateTable();
        }
        OpenConnection();
        ...
        string query = "INSERT OR REPLACE INTO " + TABLE_NAME
                ...
                + ",curr_best_fitness,starting_position,speed,time_being_alive_importance,best_distances,best_fitnesses) VALUES ("
    ...
    {
        PlayerPrefs.SetInt("visualizationDataTableCreated", 1);
        OpenConnection();
